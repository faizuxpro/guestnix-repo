...
export function CaseStudyPost({
  ...
  return (
    <article className="pb-20">
      ...
      <header className="mx-auto max-w-4xl px-6 pt-8 pb-10 lg:px-8">
      ...
      <div className="mx-auto mt-16 max-w-3xl space-y-12 px-6 lg:px-8">
        ...
        <CTA
          heading="Get results like these for your rentals."
          body="Join hundreds of hosts who use Guestnix to answer fewer questions and delight more guests."
          href="/signup"
